...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      />
      <div className="grid h-screen place-items-center justify-center items-center z-index-10">
        <div className="select-none">
          <div
            className="p-4 w-[23rem] md:w-[40rem] bg-zinc-900/30 rounded-2xl duration-700 transform opacity-0 transition-all translate-y-12 ease-out"
